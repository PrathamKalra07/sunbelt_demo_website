...
export default function PropertyChatbot() {
    ...
    return (
        <>
            ...
            {/* Dark overlay */}
            <div className="fixed inset-0 bg-black/35" style={{ zIndex: 1 }} />

            {/* Centered popup */}
            <div className="fixed inset-0 flex items-center justify-center p-6" style={{ zIndex: 2 }}>
                <div
                    className="w-full max-w-2xl flex flex-col bg-white overflow-hidden"
                    style={{
                        height: "82vh",
                        borderRadius: "18px",
                ...
                >
                    ...
                    <div className="flex items-center gap-2.5 px-4 py-3 border-b border-gray-100 bg-white flex-shrink-0">
                        ...
                        <span className="text-[11px] text-gray-300 tracking-wide">Sunbelt Properties</span>
                    </div>
                    ...
                    {/* Input */}
                    <div className="px-4 pb-4 pt-1.5 flex-shrink-0">
                        <div className={`flex items-center gap-2 rounded-xl border bg-white px-3.5 py-2 transition-colors ${canSend ? 'border-gray-900' : 'border-gray-200'}`}>
                            <input
                                ref={inputRef}
                                type="text"
                                value={input}
